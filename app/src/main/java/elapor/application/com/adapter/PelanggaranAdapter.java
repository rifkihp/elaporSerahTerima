...
public class PelanggaranAdapter extends BaseAdapter {

	ArrayList<pelanggaran> listdata = new ArrayList<>();
	Context context;

	public PelanggaranAdapter(Context context, ArrayList<pelanggaran> listdata) {
		this.context = context;
		this.listdata = listdata;
	}

	public void UpdatePelanggaranAdapter(ArrayList<pelanggaran> listdata) {
		this.listdata = listdata;
	...
	public View getView(int position, View convertView, final ViewGroup parent) {
		...
		if(convertView==null) {
			view = new ViewHolder();
			convertView = inflator.inflate(R.layout.pelanggaran_item_list, null);
		...
		final pelanggaran info = listdata.get(position);
		...
		view.keterangan.setText("Nama Pelanggar "+info.getNama()+"\nPasal: "+info.getPasal());
		...
		view.delete.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				((MainActivity) parent.getContext()).deletePelanggaran(info);
			}
		});
